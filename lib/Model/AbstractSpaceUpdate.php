...
class AbstractSpaceUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Sets postal_address
     *
     * @param \TrustPayments\Sdk\Model\SpaceAddressCreate $postal_address The address that is used in communication with clients for example in emails, documents, etc.
     *
     * @return $this
     */
