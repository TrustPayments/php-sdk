...
class Space implements ModelInterface, ArrayAccess
{
     ...
     * Sets account
     *
     * @param \TrustPayments\Sdk\Model\Account $account The account that the space belongs to.
     *
     * @return $this
     */
     ...
     * Sets database
     *
     * @param \TrustPayments\Sdk\Model\TenantDatabase $database The database the space is connected to and that holds the space's data.
     *
     * @return $this
     */
     ...
     * Sets postal_address
     *
     * @param \TrustPayments\Sdk\Model\SpaceAddress $postal_address The address that is used in communication with clients for example in emails, documents, etc.
     *
     * @return $this
     */
