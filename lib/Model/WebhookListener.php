...
class WebhookListener implements ModelInterface, ArrayAccess
{
     ...
     * Sets identity
     *
     * @param \TrustPayments\Sdk\Model\WebhookIdentity $identity The identity used to sign messages.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param \TrustPayments\Sdk\Model\WebhookUrl $url The URL where notifications about entity changes are sent to.
     *
     * @return $this
     */
