...
class Role implements ModelInterface, ArrayAccess
{
     ...
     * Sets account
     *
     * @param \TrustPayments\Sdk\Model\Account $account The account the role belongs to. The role can only be assigned within this account.
     *
     * @return $this
     */
     ...
     * Sets permissions
     *
     * @param \TrustPayments\Sdk\Model\Permission[] $permissions The permissions granted to users with this role.
     *
     * @return $this
     */
